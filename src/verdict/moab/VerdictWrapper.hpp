...
enum QualityType {
  ...
  MB_EDGE_RATIO = 0,        // 0  MBHEX, MBTET,                    MBQUAD
  ...
  MB_MAX_ASPECT_FROBENIUS,  // 10 MBHEX, MBTET (aspect_frobenius)  MBQUAD
  MB_CONDITION,             // 11 MBHEX, MBTET,                    MBQUAD
  MB_JACOBIAN,              // 12 MBHEX, MBTET,                    MBQUAD
  MB_SCALED_JACOBIAN,       // 13 MBHEX, MBTET,                    MBQUAD
  MB_SHEAR,                 // 14 MBHEX,                           MBQUAD
  MB_SHAPE,                 // 15 MBHEX, MBTET,                    MBQUAD
  MB_RELATIVE_SIZE_SQUARED, // 16 MBHEX, MBTET,                    MBQUAD
  ...
  // specific to tets
  MB_RADIUS_RATIO,          // 21        MBTET,                    MBQUAD
  MB_ASPECT_BETA,           // 22        MBTET
  MB_ASPECT_RATIO,          // 23        MBTET,                    MBQUAD
  MB_ASPECT_GAMMA,          // 24        MBTET
  MB_MINIMUM_ANGLE,         // 25        MBTET,                    MBQUAD
  MB_COLLAPSE_RATIO,        // 26        MBTET
  // specific to quads
  MB_WARPAGE,               // 27                                  MBQUAD
  MB_AREA,                  // 28                                  MBQUAD
  MB_MAXIMUM_ANGLE,         // 29                                  MBQUAD
