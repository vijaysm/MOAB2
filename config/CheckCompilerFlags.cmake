...
if (CMAKE_COMPILER_IS_GNUCXX)
  ...
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-pipe")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wno-long-long")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wextra")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wcast-align")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wsign-compare")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wpointer-arith")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wformat")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wformat-security")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wunused-parameter")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-fpermissive")
  ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-fstack-protector-all")
  ...
  IF(CMAKE_CXX_COMPILER_ID MATCHES "Intel")
    ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-ansi")  # standard compliant
    ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-w2")    # verbose warnings
    ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-Wall")
    ...
    ENABLE_IF_SUPPORTED(CMAKE_CXX_FLAGS "-wd2259")
  endif()
