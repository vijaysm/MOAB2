...
// 20 for 64-bit handles, 10 for 32-bit handles
#define MESHSET_MANAGER_LEVEL_TWO_BITS (10*sizeof(MBEntityHandle)/4)
#define MESHSET_MANAGER_LEVEL_THREE_BITS (10*sizeof(MBEntityHandle)/4)
