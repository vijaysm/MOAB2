...
extern "C" {
  ...
  enum iMesh_AdjacencyCost {
    iMesh_UNAVAILABLE = 0,          /**< Adjacency information not supported */
    iMesh_IMMEDIATE,            /**< No mesh traversal required */
    iMesh_LOCAL_TRAVERSAL,      /**< Must traverse entity's neighborhood */
    iMesh_GLOBAL_TRAVERSAL      /**< Must traverse entire mesh */
  };
  ...
  void iMesh_getEntSetData(iMesh_Instance instance,
                                ...
                                /*inout*/ int* tag_value_allocated, int *err);
