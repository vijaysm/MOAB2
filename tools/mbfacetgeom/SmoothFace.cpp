...
SmoothFace::SmoothFace(moab::Interface * mb,
...
moab::ErrorCode SmoothFace::compute_control_points_on_edges(double min_dot,
...
//===========================================================================
moab::ErrorCode SmoothFace::init_bezier_edge(moab::EntityHandle edge,
      double min_dot) {
...
moab::ErrorCode SmoothFace::compute_tangents_for_each_edge()
...
//Description:  compute the control points for an edge
//===========================================================================
moab::ErrorCode SmoothFace::init_edge_control_points(moab::CartVect &P0,
...
moab::ErrorCode SmoothFace::find_edges_orientations(
...
moab::ErrorCode SmoothFace::compute_internal_control_points_on_facets(
...
void SmoothFace::adjust_bounding_box(moab::CartVect & vect) {
   // _minim, _maxim
   for (int j = 0; j < 3; j++) {
      if (_minim[j] > vect[j])
         _minim[j] = vect[j];
...
////===============================================================
moab::ErrorCode SmoothFace::init_facet_control_points(moab::CartVect N[6], // vertex normals (per edge)
...
//===========================================================================
moab::ErrorCode SmoothFace::evaluate_smooth_edge(moab::EntityHandle eh,
...
moab::ErrorCode SmoothFace::eval_bezier_patch(moab::EntityHandle tri,
...
//===========================================================================
void SmoothFace::project_to_facet_plane(moab::EntityHandle tri,
...
//              of a facet
//===========================================================================
void SmoothFace::facet_area_coordinate(moab::EntityHandle facet,
...
moab::ErrorCode SmoothFace::project_to_facets_main(
...
moab::ErrorCode SmoothFace::project_to_facets(std::vector<
...
//===========================================================================
moab::ErrorCode SmoothFace::project_to_patch(moab::EntityHandle facet, // (IN) the facet where the patch is defined
...
//===========================================================================
void SmoothFace::ac_at_edge(moab::CartVect &fac, // facet area coordinate
...
//              a starting guess.
//===========================================================================
moab::ErrorCode SmoothFace::project_to_facet(moab::EntityHandle facet,
...
//===========================================================================
bool SmoothFace::is_at_vertex(moab::EntityHandle facet, // (IN) facet we are evaluating
...
//===========================================================================
bool SmoothFace::move_ac_inside(moab::CartVect &ac, double tol) {
   int nout = 0;
   if (ac[0] < -tol) {
      ac[0] = 0.0;
...
//===========================================================================
moab::ErrorCode SmoothFace::eval_bezier_patch_normal(
...
moab::ErrorCode SmoothFace::get_normals_for_vertices(
...
moab::ErrorCode SmoothFace::find_loops() {
   ...
   moab::Tag geom_tag;
   moab::ErrorCode rval =
         _mb->tag_get_handle(GEOM_DIMENSION_TAG_NAME, geom_tag);
...
moab::ErrorCode SmoothFace::ray_intersection_correct(moab::EntityHandle facet, // (IN) the facet where the patch is defined
